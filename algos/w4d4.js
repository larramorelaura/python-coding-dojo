...
function binaryStringExpansion(str, results) {
    ...
    if (i==-1){
        ...
        console.log(newstr);
        binaryStringExpansion(newstr, arr);
        newstr2= str.substring(0,i) + '1' + str.substring(i+1);
        console.log(newstr2);
        binaryStringExpansion(newstr2, arr);
    }
    return arr;
...
console.log(binaryStringExpansion(str1,0)) // expected ["1000", "1001", "1100", "1101"]
console.log(binaryStringExpansion(str2,0)) // expected ['000', '001', '010', '011', '100', '101','110', '111']
